// DeltaForge on Azure - Professional tier ("Plan B" per-slot autoscaler pool).
//
...
//
// slotCount = 9: the Professional license node ceiling (10) minus the 1 always-on
...
// ----------------------------- Tier constants -------------------------------
var tier = 'professional'
var slotCount = 9 // Professional ceiling (10 nodes) minus the 1 embedded platform node.
