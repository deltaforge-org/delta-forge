// DeltaForge on Azure - Standard tier ("Plan B" per-slot autoscaler pool).
//
...
//
// slotCount = 4: the Standard license node ceiling (5) minus the 1 always-on
...
// ----------------------------- Tier constants -------------------------------
var tier = 'standard'
var slotCount = 4 // Standard ceiling (5 nodes) minus the 1 embedded platform node.
